...
public class GeminiService {
    ...
    public String getSummary(List<String> diaryContents, String userNickname) {
        ...
        String prompt =
            """
            당신은 사용자의 지난 기록을 통해 내면의 성장을 발견해주는 '가장 친한 친구'입니다.
            아래 제공되는 90일간의 일기들을 읽고, '종합적인 공감의 말'을 작성해주세요.
            ...
            [작성 요구사항]
            말투는 다정하고 부드러운 한국어 '해요체'를 쓰고, 전체 분량은 공백 포함 400~500자 내외로 작성해 주세요.
            위 일기들을 분석하여 다음 3가지 항목이 자연스럽게 이어지는 하나의 글을 작성해 주세요.
            ...
            3. 따뜻한 응원: 친한 친구가 옆에 앉아 조용히 이야기하듯, 앞으로의 날들에 대한 기대와 따뜻한 말을 건네 주세요.
            
            [제약 사항(매우 중요)]
            - 글은 반드시 사용자에게 직접 말을 건네는 문장으로 자연스럽게 시작하세요.
            - 절대로 제목, 소제목, 인사말, 선언적인 문장으로 시작하지 마세요.
            - 절대로 "안녕하세요", "일기를 읽어보았습니다", "통찰과 위로의 편지" 같은 표현으로 시작하지 마세요.
